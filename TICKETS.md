...
| CMP-010 | Fotos reales para los 4 slots restantes de Gallery (On Stage, Workshop, Community, Behind the Scenes) | in-progress | `CMP-010-galeria-fotos-reales` | 2026-09-04 | Agrega `on-stage.jpg`, `workshop.jpg`, `community.jpg`, `behind-the-scenes.jpg` a `public/images/` (convertidas de PNG a JPEG, redimensionadas) y las engancha en `SLOTS` de `Gallery.jsx`. Ya no queda ningún slot en gradiente placeholder. |
