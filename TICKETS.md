...
| CMP-012 | Proceso de primer release (deploy a GoDaddy + GitHub Release) | in-progress | `CMP-012-primer-release-godaddy-github` | 2026-09-04 | Documenta `docs/process/release-checklist.md` (versionado, build, subida manual a GoDaddy `public_html/` vía cPanel File Manager, tag + `gh release create`) y engancha el link en `01-tech-stack.md`. Guía el primer release real del sitio en camihernandez.com. |
