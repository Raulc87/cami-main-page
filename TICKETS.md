...
| CMP-008 | 3 testimonios reales (Melissa, Rocío, Stefanny) con foto, reemplazan a los últimos 3 ficticios | in-progress | `CMP-008-testimonios-melissa-rocio-stefanny` | 2026-09-03 | Reemplaza Diego R./Valentina P./Andrés C. — ya no queda ningún testimonio ficticio. Extiende el mecanismo see more/see less (antes exclusivo del destacado) a cualquier testimonio del grid con `quoteLong`; Stefanny lo usa. |
