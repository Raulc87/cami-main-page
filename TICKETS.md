...
| CMP-004 | README del repo | in-progress | `CMP-004-readme` | 2026-08-21 | Crea `README.md` en la raíz: qué es el proyecto, cómo correrlo localmente, scripts, deploy, y puntero a `AGENTS.md`/`docs/specs/` como fuente de verdad. |
